...
@section('content')
    ...
    <!-- Main Content -->
    <main class="main-content" style="margin-top:9.5vh !important; margin-bottom: 8vh;">
    ...
    <div class="bottom-nav d-flex d-lg-none"
        ...
        <div class="nav-item"
            ...
            <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24"
                style="color:#6c757d; margin-bottom:0.25rem;">
                <path
        ...
        <div class="nav-item"
            style="display:flex; flex-direction:column; align-items:center; fill:#0d6efd; font-size:0.75rem;">
            <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24"
