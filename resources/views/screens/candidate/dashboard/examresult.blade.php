                            ...
                            <h2 class="accordion-header" id="heading-{{ $question->id }}">
                                <button class="accordion-button collapsed " type="button" data-bs-toggle="collapse"
                                    ...
                                    <div class="container d-flex" style="justify-content: flex-end">
                                        ...
                                        <div class="question-status mr-3 ml-3 pr-3 {{ $questionStatusClass }}">
                                            <i class="{{ $iconClass }}"></i>
                                            {{ $statusText }}
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-body">
                                    @if ($question->type === 'multiple-choice')
                                        ...
                                        <ul class="options-list">
                                            ...
                                            @endforeach
                                            <div class="ms-auto "
                                                style="padding: 5px 10px; background:#00ff885e; margin-top:10px; border-radius: 20px">
                                                Correct Answer: {{ $correctAnswerText }}</div>
                                        </ul>
                                    @else
                                        <p><strong>Your Answer:</strong></p>
                                                ...
                                                <div class="accordion-item nested-accordion-item">
                                                    <h2 class="accordion-header">
                                                        <button class="accordion-button collapsed" type="button"
                                                            ...
                                                            data-bs-target="#feedback-{{ $question->id }}"
                                                            aria-expanded="false"
                                                    ...
                                                    <div id="feedback-{{ $question->id }}"
                                                        ...
                                                        data-bs-parent="#feedback-accordion-{{ $question->id }}">
                                                        <div class="accordion-body">
